...
export default function Hero() {
  return <section id="inicio" className="carbon-grid hero-motion relative isolate overflow-hidden">
    ...
    <div className="section relative flex min-h-[calc(100svh-72px)] max-w-6xl items-center py-16 sm:py-24"><div className="max-w-xl hero-copy">
      <h1 className="font-display text-6xl leading-[.83] tracking-wide sm:text-8xl">TU AUTO.<br /><span className="text-red">OTRA PRESENCIA.</span></h1>
      <p className="mt-6 max-w-md text-base leading-relaxed text-white/80 sm:text-lg">Polarizados, láminas de seguridad y cuidado vehicular con terminaciones prolijas y tiempos que se cumplen.</p>
